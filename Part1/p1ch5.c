...
Date:		03.05.2022
Synopsis:	This is a simple program that listst three kids and their school supply needs, as well as cost to buy the supplies.
*/
...
int main()
{
	...
	printf("The total cost is $%.2f\n",
			number_of_pencils*pencils + number_of_notebooks + lunchbox);
	return 0;
}
