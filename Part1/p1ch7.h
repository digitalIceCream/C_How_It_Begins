...
Date:		03.05.2022
Synopsis:	A program demonstrating the use of #include and #define (preprocessor directive and NOT comments!).
*/

#include <stdio.h> // essentially a file-merge command, allows for the use of the printf() function e.g..
		   // built-in files are called with <filename>
...
// if you need them in multiple programs, you can place the in a header file like:
